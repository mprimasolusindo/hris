...
export default function Index({
    ...
    return (
        <MasterCrudPage<ComponentRow>
            ...
            storeUrl={route('payroll.master-allowances.store')}
            updateUrl={(id) => route('payroll.master-allowances.update', id)}
            destroyUrl={(id) => route('payroll.master-allowances.destroy', id)}
        />
    );
}
